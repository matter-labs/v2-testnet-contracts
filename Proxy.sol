...
contract Proxy {
    ...
    fallback() external payable {
        ...
        Diamond.Facet memory facet = diamondStorage.selectorsToFacet[msg.sig];
        require(facet.addr != address(0), "F"); // Proxy has no facet for this selector
        require(!diamondStorage.isFreezed || !facet.isFreezable, "q1"); // Facet is freezed
        address facetAddress = facet.addr;
        assembly {
